...
\begin{cventries}
    ...
    \cventry
    {Flavian Kaufmann}
    {Reliable Transport for the Lauberhorn Smart NIC}
    {Bachelor Thesis}
    {Feb.\ 2026 - Aug.\ 2026}
    {}
    ...
    \cventry
    {Hannah Osswald}
    {Unmarshaling Unit for the Lauberhorn Smart NIC}
    {Bachelor Thesis}
    {Feb.\ 2026 - Aug.\ 2026}
    {}
    ...
    \cventry
    {Hannah Osswald}
    {A Coyote-like Shell for Cache-Coherent Hybrid Systems}
    {Bachelor Thesis}
    {Sept.\ 2025 - Mar.\ 2026}
    {}
    ...
    \cventry
    {Ram\'on Buchenberger}
    {USB Subsystem Support for an OS Course}
    {Semester Project}
    {Sept.\ 2024 - Mar.\ 2025}
    {}
    ...
    \cventry
    {Tobias M\"uller}
    {Hybrid FPGA-Accelerator Encryption and Compression}
    {Bachelor Thesis}
    {Feb.\ 2024 - Aug.\ 2024}
    {}
\end{cventries}
