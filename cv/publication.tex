...
%---------------------------------------------------------
  \cventry
    {arXiv}
    {{\normalfont Zikai Liu, Niels Pressel, Jasmin Schult, Roman Meier, \textbf{Pengcheng Xu}, Timothy Roscoe. ``Proxics: an efficient programming model for far memory accelerators''}}
    {Online} % Location
    {Apr.\ 2026} % Date(s)
    {}
...
%---------------------------------------------------------
  \cventry
    {Asia-Pacific Workshop on Systems (APSys), co-located with SOSP 2025}
